...
public final class SendCoinsFragment extends SherlockFragment
{
	...
	public View onCreateView(final LayoutInflater inflater, final ViewGroup container, final Bundle savedInstanceState)
	{
		...
		receivingStaticView.setOnFocusChangeListener(new OnFocusChangeListener()
		{
			...
			{
				if (hasFocus)
					actionMode = activity.startActionMode(new ReceivingAddressActionMode(paymentIntent.hasAddress() ? paymentIntent.getAddress()
	...
	private void updateView()
	{
		...
		if (paymentIntent.hasOutputs())
		{
			...
			if (paymentIntent.hasAddress())
				...
				receivingStaticAddressView.setText("unknown"); // TODO ======================== LOCALIZE!!!!!!
		}
